...
function interactWithLocalStorage(interactMethod) {
  ...
  if (interactMethodLower === "set")
    localStorage.setItem("allProducts", JSON.stringify(allProductsArr));
...
searchInput.addEventListener("input", () => {
  ...
  if (checkedRadioParent == null && searchInput.value !== "")
    return showError("Check any search option at first!");
